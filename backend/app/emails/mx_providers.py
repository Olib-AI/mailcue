...
The ``accept_all_bounce_prior`` values are seeded cold-start estimates, not
measurements. They set the prior mean of the beta-binomial in
``validation_feedback`` and are progressively overridden by observed outcomes
once a domain or provider accumulates enough samples.
"""
