...
_BODIES = (
    ...
    "Hi,\n\nI am checking whether the current plan still works for you. Let me know when you have a chance.\n\nBest,",
    "Hello,\n\nHere is a brief note to keep everything moving. I am available if any details need clarification.\n\nThanks,",
    "Hi there,\n\nI wanted to touch base before we move to the next step. Does the timing still look right?\n\nRegards,",
    "Hello,\n\nJust sharing a quick update from my side. There are no issues to report at the moment.\n\nBest,",
    "Hi,\n\nI reviewed the notes and everything appears to be in order. Please send any updates when convenient.\n\nThank you,",
    "Hello,\n\nI wanted to make sure we are aligned on the next step. A short confirmation would be helpful.\n\nThanks,",
    "Hi there,\n\nThis is a quick check on the schedule for the coming days. Let me know if anything has changed.\n\nBest,",
    "Hello,\n\nI am following up with one small question: are we still on track with the current timeline?\n\nRegards,",
    "Hi,\n\nA short note to confirm that I have the latest information. I will keep an eye out for your reply.\n\nThanks,",
    "Hello,\n\nI hope your day is going well. I wanted to check whether there is anything else needed from me.\n\nBest,",
    "Hi there,\n\nI am touching base about our recent discussion. Everything is ready on my side.\n\nThank you,",
    "Hello,\n\nCould you let me know if the proposed timing is still convenient? There is no urgency.\n\nRegards,",
    "Hi,\n\nI wanted to share a brief progress note. The current plan is moving forward as expected.\n\nBest,",
    "Hello,\n\nJust checking that my previous note reached you successfully. Please reply whenever convenient.\n\nThanks,",
    "Hi there,\n\nI looked over the details again and they make sense to me. Let me know your thoughts when you can.\n\nRegards,",
    "Hello,\n\nA quick message to keep our notes current. Has anything changed since the last update?\n\nBest,",
    "Hi,\n\nI am planning the next step and wanted to confirm your availability. Any convenient time is fine.\n\nThank you,",
    "Hello,\n\nI wanted to close the loop on the item we discussed. Please confirm when you have a moment.\n\nThanks,",
    "Hi there,\n\nEverything remains on schedule here. I am checking whether the same is true on your side.\n\nBest,",
    "Hello,\n\nThis is a brief follow-up before the end of the week. I hope all is going smoothly.\n\nRegards,",
)
_REPLIES = (
    ...
    "Thanks for the note. The current plan works for me.",
    "Received, thank you. I will let you know if anything changes.",
    "That sounds good. I appreciate the quick follow-up.",
    "Everything is clear on my side. Thanks for confirming.",
    "Yes, the timing still works. Thank you for checking.",
    "I have the update. We are all set for the next step.",
    "Thanks, I saw your message and the details look right.",
    "Confirmed. There is nothing else needed from my side right now.",
    "I appreciate the reminder. Everything remains on schedule.",
    "Thanks for following up. I will keep you posted.",
    "Yes, I received the earlier note. All looks good.",
    "The plan makes sense to me. Thanks for the update.",
    "Received and noted. I hope the rest of your week goes well.",
    "Thanks, the proposed time is convenient for me.",
    "I have reviewed it and everything is in order.",
    "That works well. Thank you for confirming the details.",
    "Message received. I do not have any changes to add.",
    "Thanks for checking. We can continue with the current plan.",
    "All clear here. I appreciate you keeping me updated.",
    "Confirmed on my end. Please proceed when ready.",
)
